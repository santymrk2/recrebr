...
export const metadata: Metadata = {
  title: "B&R — Recreación e Inflables | Sitio clásico",
  description: "El sitio clásico de B&R Recreación e Inflables.",
};
...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      <a href="/" style={{ position: "fixed", top: 12, left: 12, zIndex: 10000, padding: "8px 10px", borderRadius: 99, background: "#ffffffdd", color: "#111", fontFamily: "Arial, sans-serif", fontSize: 12, textDecoration: "none" }}>Conocé la nueva RECREBR</a>
      <CatalogPortal>
