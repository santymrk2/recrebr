...
import { RecrebrFloat } from "./RecrebrFloat";
...
export function RecrebrLanding() {
  return <main className="recrebr">
    ...
    <footer><a className="recrebr-logo" href="#inicio">RECRE<span>BR</span></a><p>B&amp;R RECREACIÓN<br /><b>LA RECREACIÓN SE VIVE</b></p><div><a href="https://instagram.com" target="_blank" rel="noreferrer">Instagram</a><a href="https://threads.net" target="_blank" rel="noreferrer">Threads</a><a href={wa(eventMessage)} target="_blank" rel="noreferrer">WhatsApp</a></div><small>© {new Date().getFullYear()} RECREBR · <a href="/v1">Ver sitio clásico</a></small></footer><RecrebrFloat />
  </main>;
}
